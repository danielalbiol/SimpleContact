...
class __TwigTemplate_0feef196ebacfdfd903158747d7f35d521d71cb52c6f9a128d2d30c203ade677 extends Twig_Template
{
    private $source;
    ...
    ";
        ...
        if ((isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new Twig_Error_Runtime('Variable "error" does not exist.', 6, $this->source); })())) {
            // line 7
            echo "        <div>";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new Twig_Error_Runtime('Variable "error" does not exist.', 7, $this->source); })()), "messageKey", []), "html", null, true);
            echo "</div>
    ";
        }
        // line 9
...
";
    ...
    {
        return array (  95 => 16,  86 => 10,  83 => 9,  77 => 7,  75 => 6,  72 => 5,  63 => 4,  45 => 3,  15 => 1,);
    }
...
{% block body %}
    ...
    <form action=\"{{ path('login') }}\" method=\"post\">
        ...
        <input type=\"password\" id=\"password\" name=\"_password\"/>
        <button type=\"submit\">Entrar</button>
        <a href=\"{{ path('register') }}\">Registrar</a>
    </form>
{% endblock %}", "login/login.html.twig", "/home/admin01/Escritorio/DWES/contactos/templates/login/login.html.twig");
    }
}
