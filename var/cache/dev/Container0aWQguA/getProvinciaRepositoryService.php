...
// Returns the private 'App\Repository\ProvinciaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ProvinciaRepository.php';

return $this->privates['App\Repository\ProvinciaRepository'] = new \App\Repository\ProvinciaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
