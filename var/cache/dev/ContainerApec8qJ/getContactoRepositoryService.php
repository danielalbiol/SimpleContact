...
// Returns the private 'App\Repository\ContactoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ContactoRepository.php';

return $this->privates['App\Repository\ContactoRepository'] = new \App\Repository\ContactoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
